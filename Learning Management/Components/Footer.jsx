    ...
    <div className="footer">
        <div className="footer0">
            <div className="footer1">
                <a href=""><img src="./public/Byway-white.png" alt="logo" /></a>
            ...
            <div className="footer2">
                ...
                <p>Latest Articles <a href=""></a></p>
                <p>FAQ <a href=""></a></p>
            </div>
            <div className="footer3">
                <h4>Programs</h4>
                <p>Art & Design <a href=""></a></p>
                <p>Business <a href=""></a></p>
                <p>IT & Software <a href=""></a></p>
                <p>Languages <a href=""></a></p>
                <p>Programming <a href=""></a></p>
            </div>
